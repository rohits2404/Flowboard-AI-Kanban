            ...
            <div className="relative mx-auto grid max-w-6xl items-center gap-12 px-6 lg:grid-cols-2">
                ...
                <div>
                    ...
                    <p className="mt-4 max-w-md leading-relaxed text-white/80">
                        Stop staring at an empty board.
                        Flowboard's AI plans, breaks down
                        and reports on your work so you can
                        focus on shipping.
                    </p>
                    ...
                    >
                        <button className="inline-flex h-11 items-center justify-center gap-2 rounded-full bg-white px-6 text-sm font-semibold text-brand-700 shadow-(--shadow-card) transition-transform duration-200 hover:scale-[1.02] active:scale-[0.97]">
                            Try it free
