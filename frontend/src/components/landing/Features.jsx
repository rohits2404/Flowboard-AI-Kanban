    ...
    >
        ...
        <div className="mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-3 lg:auto-rows-fr">
            ...
            <motion.div
                ...
                className="brand-gradient group relative flex flex-col overflow-hidden rounded-3xl p-8 text-white shadow-(--shadow-lift) sm:col-span-2 lg:row-span-2"
            >
                {/* ambient glows */}
            ...
            {features.map((f, i) => (
                <motion.div
                    ...
                    className="group relative overflow-hidden rounded-3xl border border-line bg-surface p-7 shadow-(--shadow-card) transition-all duration-300 hover:-translate-y-1 hover:border-brand-100 hover:shadow-(--shadow-soft)"
                >
                    {/* glow that blooms from behind the icon on hover */}
                    <div className="pointer-events-none absolute -left-6 -top-6 h-28 w-28 rounded-full bg-brand-500/8 opacity-0 blur-2xl transition-opacity duration-500 group-hover:opacity-100" />
