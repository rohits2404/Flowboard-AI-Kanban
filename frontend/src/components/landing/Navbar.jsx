        ...
        >
            <div
                className={`mx-auto flex items-center justify-between transition-all duration-300 ease-spring ${
                    scrolled
                        ? "glass mt-3 max-w-5xl rounded-full border border-line px-5 py-2.5 shadow-(--shadow-soft)"
                        : "max-w-6xl px-6 py-3.5"
                }`}
            >
                <Link to="/" className="flex items-center gap-2.5 font-semibold">
                    <div className="brand-gradient flex h-9 w-9 items-center justify-center rounded-xl shadow-(--shadow-brand)">
