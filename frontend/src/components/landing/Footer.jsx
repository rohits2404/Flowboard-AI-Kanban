        ...
        <div className="mx-auto max-w-6xl px-6 py-14">
            <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <div className="lg:col-span-2">
                    ...
                    >
                        <span className="brand-gradient flex h-9 w-9 items-center justify-center rounded-xl shadow-(--shadow-brand)">
                    ...
                    <p className="mt-4 max-w-xs text-sm leading-relaxed text-muted">
                        The AI-native Kanban that turns goals into
                        shipped work — planning less so your team
                        ships more.
                    </p>
                </div>
            ...
            <div className="mt-12 flex flex-col items-center justify-between gap-3 border-t pt-6 text-sm text-muted sm:flex-row">
                <span>
                    © {new Date().getFullYear()} Flowboard. All rights
                    reserved.
                </span>
