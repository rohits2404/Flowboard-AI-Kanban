...
export const FinalCTA = () => (
    <section className="mx-auto max-w-6xl px-6 py-20 sm:py-28">
        <motion.div
            ...
            className="relative overflow-hidden rounded-4xl border border-line bg-surface px-6 py-16 text-center sm:py-20"
        >
            ...
            <div className="relative">
                ...
                <p className="mx-auto mt-5 max-w-xl text-lg leading-relaxed text-muted">
                    Join teams turning goals into shipped work
                    with an AI-native Kanban. Free to start.
                </p>
